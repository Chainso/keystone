  ...
  'relative w-full cursor-text select-text overflow-y-auto caret-primary selection:bg-brand/25 focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-brand/25 [&_.slate-selection-area]:bg-brand/15',
  {
    ...
    variants: {
      variant: {
        ...
        workspaceDocument: cn(
          'min-h-[13rem] rounded-md border border-input/80 bg-background',
          'transition-colors',
          'has-[[data-slate-editor]:focus]:border-brand/50 has-[[data-slate-editor]:focus]:ring-2 has-[[data-slate-editor]:focus]:ring-brand/20',
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        workspaceDocument: 'min-h-[13rem] px-4 py-3 text-base leading-7',
      },
    },
  }
);
