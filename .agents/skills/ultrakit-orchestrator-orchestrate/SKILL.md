...
- **Review agents**: spawn the project-scoped `ultrakit_reviewer` subagent. It is pinned to `gpt-5.4-mini`.
- **Implementation and fix work**: spawn the project-scoped `ultrakit_implementer` subagent and keep the current session in the orchestrator role.
