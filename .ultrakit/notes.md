...
- `demo:validate` now requires a well-formed workflow graph for public `scripted` and `think_live` proofs: at least three tasks, at least two roots, at least one dependency edge, and resolvable dependency references.
