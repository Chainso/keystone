/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8fa3441681f80e25474698b5e461394b)
// Runtime types generated with workerd@1.20260410.1 2026-04-14 experimental,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TaskSessionDO" | "Sandbox" | "KeystoneThinkAgent" | "PlanningDocumentAgent";
	}
	interface Env {
		...
		KEYSTONE_COMPILE_CHAT_COMPLETIONS_MODEL: "gpt-5.5";
		...
		TASK_SESSION: DurableObjectNamespace<import("./src/index").TaskSessionDO>;
		KEYSTONE_THINK_AGENT: DurableObjectNamespace<import("./src/index").KeystoneThinkAgent>;
		PlanningDocumentAgent: DurableObjectNamespace<import("./src/index").PlanningDocumentAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KEYSTONE_CHAT_COMPLETIONS_BASE_URL" | "KEYSTONE_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_PLANNING_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_COMPILE_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_IMPLEMENTER_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_SPECIFICATION_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_ARCHITECTURE_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_EXECUTION_PLAN_CHAT_COMPLETIONS_MODEL" | "KEYSTONE_DEV_TOKEN" | "KEYSTONE_DEV_TENANT_ID" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
